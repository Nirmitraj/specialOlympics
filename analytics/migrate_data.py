    ...
    def handle(self, *args, **kwargs):
        ...
        with open(datafile, newline='', encoding='utf-8-sig') as csvfile:
            ...
            for row in reader:
                ...
                # special_education_teachers=self.clean_SONA_playbook_null(row['Y15_F3_1']),#123
                # general_education_teachers=self.clean_SONA_playbook_null(row['Y15_F3_2']),#123
                # physical_education_teachers=self.clean_SONA_playbook_null(row['Y15_F3_3']),#123
                # adapted_pe_teachers=self.clean_SONA_playbook_null(row['Y15_F3_4']),#123
                # athletic_director=self.clean_SONA_playbook_null(row['Y15_F3_5']),#123
                # students_with_idd=self.clean_SONA_playbook_null(row['Y15_F3_6']),#123
                # students_without_idd=self.clean_SONA_playbook_null(row['Y15_F3_7']),#123
                # school_administrators=self.clean_SONA_playbook_null(row['Y15_F3_8']),#123
                # parents_of_students_with_idd=self.clean_SONA_playbook_null(row['Y15_F3_9']),#1
                ...
                # special_olympics_state_program_staff=self.clean_SONA_playbook_null(row['Y15_F3_12']),#123
