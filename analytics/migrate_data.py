    ...
    def handle(self, *args, **kwargs):
        ...
        with open(datafile, newline='', encoding='utf-8-sig') as csvfile:
            ...
            for row in reader:
                ...
                special_education_teachers=self.clean_str_null(row['Y14_G2_1']),#123
                general_education_teachers=self.clean_str_null(row['Y14_G2_2']),#123
                physical_education_teachers=self.clean_str_null(row['Y14_G2_3']),#123
                adapted_pe_teachers=self.clean_str_null(row['Y14_G2_4']),#123
                athletic_director=self.clean_str_null(row['Y14_G2_5']),#123
                students_with_idd=self.clean_str_null(row['Y14_G2_6']),#123
                students_without_idd=self.clean_str_null(row['Y14_G2_7']),#123
                school_administrators=self.clean_str_null(row['Y14_G2_8']),#123
                ...
                school_psychologist=self.clean_str_null(row['Y14_G2_10']),#123
                special_olympics_state_program_staff=self.clean_str_null(row['Y14_G2_11']),#123
